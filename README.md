...
This project makes use of [grunt-webfonts-zwc](https://github.com/RealityRipple/grunt-webfonts)
...
The necessary tools can be installed via npm:
    ...
    # install dependencies from packages.json, including `grunt-webfonts-zwc`.
    npm install
